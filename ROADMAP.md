...
The active lineage is `shared:restart-20260918-01`, now saved at seq250 with 217 archived attempts and 231 world usage records under [worlds/](worlds/README.md). Original seq450 and its separate local seq452 continuation remain unchanged. H117, H119, H120, H121, H122, H123 and H124 resumed real resident calls under authorized supplemental accounting, conservatively retaining every old liability and unknown. The missing provider ledger is not claimed recovered. On September 19–20, 84 additional Kimi calls settled for CNY 1.7586702 after the earlier baseline; Rowan adopted self-repair, Iris acted on terminal resource feedback and later recovered finite iron, Smith discovered and recovered iron, then turned an exhausted-source result into a direct work conversation, and the natural edge-repair contract remains uncompleted. GM04 completed one measured new-epoch effect review, with separate unpriced token usage. The 15-minute engineering heartbeat remains active; live episodes stay bounded and credentials remain local.

The active lineage has since advanced to seq264 with 243 world usage records and CNY 2.0092732 of additional Kimi cost after the earlier baseline. H126's 12 calls settled with no unknowns; its 600-second capture resolved and drained internally, but the outer runner timed out while closing. H130 formally settled the pre-existing Carpenter command in a verified physics-only continuation: the exhausted source returned `material_depleted` with zero quantity, no inventory changed, and no model call was made. The public checkpoint and exact cold restore now reach seq264. Natural material transfer, edge repair and sustainable resources remain open.
