...
| M20G | [十人实际街道与冷恢复画面](docs/validation/gpt6_sprint_2026-09-12.md)与[既有美术扩建街区](docs/validation/town_expansion_2026-09-12/report.md)：14栋新住宅（六种外壳）、两片住宅街区与庭院、种植公共地与果园/商队休息区，38件2026-09-12新生成模型（店面细节16、工坊工具12、旅运货物10）＋50件v2环境与18件外围景观，全部实际加载；23个到达路点（含起点共24）279.5米往返物理行走、路口坡道与胶囊净空、实体道具阻挡均通过 | 有界绿（仅到此范围）：扩建是美术/空间，不改变居民选择或资源拥堵；命名地点与自愿出行是下一交付。正式人物、室内与美术完善仍归N5。 |
