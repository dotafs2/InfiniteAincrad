...
flowchart TD
    ...
    H101E --> H101E3
    H101E3["烘焙代码已合入本地 main，53项离线验收通过<br/>真实炉位、炉体碰撞和导航仍待验证，尚未安装<br/>原居民采用及原GM复查均待证据"]
    H101E --> H101E4
    H101E4["持续运行仍待完成：面包师上下文故障已真实复验修复<br/>life12结束时两名居民失败；一笔已付费结果未写回<br/>下一项先补停机等待、结果接续，再继续长跑"]
    H101E --> N5
    H79 --> M20E
    M20E --> M20
    M20 -.持续稳定性.-> M20F
