...
## 2026-09-25 · H163 Portrait city kit, 208 Blender assets and animated stick figures

Implemented the user's next reference-game milestone with 208 original geometry-distinct Blender assets: 48 buildings, 32 vehicles, 64 street props, 48 plants and 16 rigged stick figures, including related structural variants. All are instantiated in the 443-object playable city. Sixty-four pedestrians play imported Idle/Walk/Run clips while resting, walking and fleeing. A 540×960 portrait interface has one-finger movement, release-to-stop and on-screen pause; rim tipping remains intact. Blender MCP's official command handlers were used through a local main-thread background transport, because upstream's GUI timer server rejects headless Blender. No desktop window or focus change occurred. All 98 checks pass (22 portrait, 25 rim, 24 first-level, 27 legacy); the final ordinary regression was eaten at 60 points, while the separate rivals-retired reachability fixture earned 510. Actual headless WebGL touch checks, Windows packaged startup, a 42.5-second ordinary-input gameplay excerpt and a separate 10-second animation preview are delivered. Exact map/art matching, shops, skins, later levels and balancing remain incomplete. The town, provider ledgers, project goal and hourly automation remain paused. [Evidence, model catalog and videos](docs/validation/hole-city-portrait-20260925/README.md).

## 2026-09-24 · H162 Rim tipping correction and recorded evidence

After receiving a 69-second ordinary-input bot video (518 points, level 9), the user pointed out that objects fell almost vertically. The reference scene now preserves rim contacts, wakes before the complete footprint enters, and lets gravity and asymmetric support create the initial tip. Bounded attraction follows the hole; a lower-end force helps long tilted objects avoid bridging the mouth. Rotated bounds control collision release and exactly-once collection. The original prototype keeps its prior physics. All 25 new rim checks, 24 first-level checks at normal 60 Hz physics, and 27 legacy checks pass. The ordinary seven-rival regression run earned 501 points and completed in 72.317 simulated seconds. A 38-second headless-rendered, explicitly labelled 0.5x controlled close-up shows the actual authored car, street light and building tipping; the Windows export passes headless startup. No desktop window or provider operation occurred. [Evidence and video](docs/validation/hole-city-rim-20260924/README.md).

## 2026-09-24 · H161 Live Poki reference and first reconstruction stage

The user clarified the exact Poki Hole.io page and required self-authored art. A separate headless browser observed the live menu, tutorial, four-minute/500-point round, EATEN-to-home flow, store and skin library. The new default `fidelity/main.tscn` follows that first-screen/first-level composition using original procedural models and vector UI; the older independently styled prototype remains preserved. Twenty-four headless checks pass. A live-rival automated round earned 113 points and ended by being eaten; a separate fixture with rivals retired reached 513 points through normal movement and falling objects, without score grants. Headless WebGL render/input checks and Windows export startup pass. This is an explicitly partial reconstruction: exact growth, map geometry, all skins, shops, later levels, rewards and final result art remain pending. No desktop window, focus change, town advancement, provider operation or reset occurred. [Reference ledger](experiments/hole-city/fidelity/REFERENCE.md) · [Verification and authored screenshots](docs/validation/hole-city-fidelity-20260924/README.md).
...
## 2026-09-24 · H157 Nutrition effect acknowledged, sleep recovery and exact seq378 continuity

GM05 accepted the exact nutrition effect receipt after Ari voluntarily completed a meal while citing the disclosed threshold and return. All nine requests in that partial window carried the rule. An idle-sleep event interrupted its requested900 seconds at121.933 world seconds; the failed run remains failed. Seq360 cold restore preserved four jobs, and a clean120-second recovery advanced toseq368. A process-scoped Windows awake guard now restores prior state after engine/gateway drain; all35 launcher tests and a native API restoration check passed. The subsequent300-second run met duration but remains validation-failed because Fern returned an overlong reason. Both Wren harvest29 and30 correctly failed for unavailable stock while a naturally replenished ration was harvested by Ari. A separate no-dispatch startup failure spent nothing; the existing one-shot reason recovery then completed60 seconds toseq378 with three settled calls. Exact cold restore and global/per-resident food conservation pass. One newer Wren harvest remains pending; Flint has a recoverable stale-option wait, not a provider error. GM05 accepted the terminal receipt and declined a new food-system change from this evidence. Current portable usage preserves350 measured NPC calls,42 GM attempts and8,293,722 known GM tokens, with historical unknowns retained. The continuation now has62 new settled resident calls costing CNY1.3016542. The late third direction review is explicit; no missed hourly reviews are fabricated. [Resident report](worlds/restart-20260918-01/observations/iteration-20260924/report.zh-CN.md) · [Terminal GM feedback](worlds/restart-20260918-01/gm/seq000378-gm05-harvest-terminal-feedback.json)

## 2026-09-24 · H156 Resident nutrition disclosure from a reviewed GM repair

Native GPT-6 Luna GM05 claimed the host-selected nutrition-information gap. The initial automatic cycle could not provision a candidate in a linked worktree; its failure and measured feedback remain recorded. Two focused tooling corrections resolved common Git object-store lookup and incomplete Windows process-census reporting (222 relevant tests passed, five skipped). The first coding revision was rejected for an uninitialized rules map and a source-string-only test. The same coding session repaired it, preserved the host behavioral fixture and passed unchanged scope guards. Host acceptance now passes36 real nutrition checks,36 resident-turn checks,16 wake checks and seed/cold C# gateway projection with the exact rule present in all three wire requests. Residents learn the existing one-ration/+40 fullness/100 cap/30-second/80-or-lower rule; eligibility, production, autonomy and resource effects remain unchanged. Source commit a508cfc is under a bounded same-world live continuation; resident effects and sustainability are not yet established. [Host review](worlds/restart-20260918-01/gm/seq000354-gm05-nutrition-host-review.json) · [Earlier overflow inference](worlds/restart-20260918-01/observations/iteration-20260924/seq344-to-354-fullness-overflow.json)

## 2026-09-24 · H155 Clean longer continuation and food-loop direction review

The maintained world advanced seq344→354 in a clean 900-second scene window, with twelve settled calls costing CNY 0.2485214, all 24 gateway workers drained and no pending job. Exact cold restore and immutable full-history/global/per-resident food conservation passed. The twelve-decision admission cap was reached; neither unrestricted sustained decision-making nor a food equilibrium is claimed. The earlier failed window remains failed. Portable usage now retains 320 measured NPC calls, 36 GM attempts and 7,343,865 known GM tokens, including historical unknown records. GM07 proposed derived direct-contact memory without claiming code ownership; no production implementation exists. The second hourly review prioritizes one useful same-world food-loop improvement over additional memory/adventure scaffolding. [Continuation](docs/iteration-20260924.md) · [Resident report](worlds/restart-20260918-01/observations/iteration-20260924/report.zh-CN.md) · [Food audit](worlds/restart-20260918-01/observations/iteration-20260924/seq323-to-354-food-audit.json)

## 2026-09-24 · H154 Reviewed GM scheduling correction and clean same-world continuation

GM-08 used native GPT-6 Luna to observe a host-reproduced missed voluntary eating-choice wake, author a scoped candidate, and accept receipt-bound feedback after host integration. The change preserves all prior admission and world authority gates. Focused runtime suites passed 16 eating-choice, 42 self-repair wake and 75 shutdown checks. The real world then advanced seq340→344 over a clean 120-second window: four calls settled for CNY 0.0882086, all workers drained, all ten controllers settled, no pending job, exact cold restore. The earlier failed 900-second episode remains failed. Natural triggering of the specific new wake and sustainable supply remain open. The portable world, GM and full-history usage snapshots are updated; native fees and old unknown usage are not represented as zero. [Continuation](docs/iteration-20260924.md) · [Clean window](worlds/restart-20260918-01/observations/iteration-20260924/seq340-to-344-window-02.json) · [GM feedback](worlds/restart-20260918-01/gm/seq000344-gm08-need-wake-feedback.json)

## 2026-09-24 · H153 Continuous town iteration and native Luna GM routing

The new isolated continuation checkout starts from `origin/ds-test` at `a787832`. The maintained world advanced seq323→340 with sixteen settled Kimi calls for CNY 0.3315271, ten settled resident controllers, no pending job and complete preserved history. Exact nested-field cold restore passed. The requested 900 simulated-second run did not finish: the owned wrapper stopped it at 990.172 wall seconds after 831.3167 world seconds, before final scene capture. Its checkpoint is retained and its failed-duration result stays explicit. A monotonic graceful-stop correction is under runtime validation.

The adventure reducer and disposable adapter now bind retries to their actual commands, reject stale/foreign gate authority, roll both states back on failed operations or saves, and persist the adventure snapshot atomically inside the town save. These are maintenance results on controlled copies; no canonical adventure adoption is claimed. The native Codex route adds `gpt-6-luna` while preserving stable GM identities and model-correct permanent usage records. GM-08 reviewed a reproduced missed wake when an eating choice first appears during cooldown and claimed the bounded scheduling issue; its implementation and real resident effect are the next step. The user requested continued completion, Luna delegation and hourly direction reviews. [Continuation](docs/iteration-20260924.md) · [Actual window result](worlds/restart-20260918-01/observations/iteration-20260924/seq323-to-340-window-01.json)
...
## 2026-09-23 · H135 Persistent provider error cleared

The active restart lineage continued from seq266 through the real repair chain to seq290. A persistent Well-keeper `brain_run_failed` was isolated to an unrefreshed runtime assembly and an adapter that collapsed the OpenGameAgent failure envelope into a generic code. The adapter now preserves the verified fixed failure identifier, the gateway preserves its local validation identifier, and a rebuilt assembly was tested with the offline gateway suite (success, bounded knowledge and context rejection).

A disposable byte-identical seq289 copy then ran one real Kimi decision for Well-keeper. The request settled, produced a normal public action, and advanced the copied world to seq290; the result was promoted as the same lineage without replaying an old request. The provider ledger has 345 settled rows, zero reserved or unknown rows, and the canonical world has ten settled resident controllers, no pending requests and no provider errors. The new checkpoint, observation report, developer usage snapshot and exact cold-restore verification are published. [Evidence](worlds/restart-20260918-01/observations/iteration-20260923/seq266-to-290-provider-cleared.json) · [Checkpoint](worlds/restart-20260918-01/checkpoints/seq000290-32d47ed3cf4771ac.world.json)

## 2026-09-23 · H136 First multi-resident continuation window

The active seq290 world ran a bounded 300-second episode with the same gateway and no reset. Twelve Kimi requests settled across six residents (baker, carpenter, gardener, healer, smith and weaver), producing ten life events; the other four residents stayed settled and retained their prior receipts. Godot exited cleanly, all 24 accepted gateway workers drained, and the world advanced to seq300 with no provider error, reserved request or unknown charge. Two basic-life jobs remain at the checkpoint boundary, so this is the first continuity sample rather than the long-term gate. [Evidence](worlds/restart-20260918-01/observations/iteration-20260923/seq290-to-300-multi-resident-window-07.json) · [Checkpoint](worlds/restart-20260918-01/checkpoints/seq000300-8576916c0a31679f.world.json)

## 2026-09-23 · H137 Second window and Baker recovery

The same world continued through a second 300-second window, settling 12 more Kimi requests and advancing seq300→316. Sixteen life events were recorded and all 24 gateway workers drained, but Baker's model returned a 516-character reason. The world kept that reply as `invalid_decision / reason_too_long` and the validation correctly failed closed; no request or charge was lost.

On the next cold start, the existing one-time length-recovery path admitted Baker exactly once. One new Kimi call settled at seq317, the original overlong receipt remained in `reviews`, and all ten resident controllers returned to `settled` with no pending job or provider error. The ledger now has 370 settled rows with zero reserved or unknown rows. [Evidence](worlds/restart-20260918-01/observations/iteration-20260923/seq300-to-317-window-08-recovery.json) · [Checkpoint](worlds/restart-20260918-01/checkpoints/seq000317-54b7a38d5b0fe11e.world.json)

## 2026-09-23 · H138 Third multi-resident continuation window

The same canonical world continued through a third 300-second window from seq317 to seq320. Smith and Carpenter produced three new settled Kimi decisions and three life events; Godot exited cleanly after draining six gateway workers. All ten resident controllers remained settled with no provider error or pending job. The provider ledger now has 373 settled rows with zero reserved or unknown requests, and the exact seq320 checkpoint plus developer usage snapshot are published. This is stronger multi-window continuity evidence, while a longer unattended run and the GM/gameplay gates remain open. [Evidence](worlds/restart-20260918-01/observations/iteration-20260923/seq317-to-320-window-10.json) · [Checkpoint](worlds/restart-20260918-01/checkpoints/seq000320-099c67a7248451dc.world.json)

## 2026-09-23 · H139 Six-hundred-second continuation window

The canonical world continued from seq320 through a 600-second live window. Two Kimi requests settled, the world reached seq321, and four accepted gateway workers drained cleanly. No provider error, reserved request or unknown charge appeared. A single Fisher physical rest command was still in progress at the checkpoint boundary; it was retained as durable world state for the next cold start rather than being discarded. [Evidence](worlds/restart-20260918-01/observations/iteration-20260923/seq320-to-321-window-11.json) · [Checkpoint](worlds/restart-20260918-01/checkpoints/seq000321-a38454ff232719fc.world.json)

## 2026-09-23 · H140 Physical-job cold-start recovery

The next cold-start continuation resumed seq321 without replaying the prior requests. The saved Fisher rest job completed, one new Kimi decision settled, and the world advanced to seq323. Godot drained two workers, the provider ledger reached 376 settled rows with zero reserved or unknown requests, and exact restore of the seq323 checkpoint passed. The world now has no pending physical job or provider error; the GM/gameplay and longer persistence gates remain open. [Evidence](worlds/restart-20260918-01/observations/iteration-20260923/seq321-to-323-window-12.json) · [Checkpoint](worlds/restart-20260918-01/checkpoints/seq000323-2d80c92778c34dc7.world.json)

## 2026-09-23 · H141 Real GM observation and feedback acknowledgement

The restored DeepSeek route completed a real GM-04 observation against the current seq323 evidence. The GM made no coding claim because the bounded packet was truncated and one source event was outside its visible projection; it returned two `observe` outcomes with measured usage. A host receipt bound to the exact evidence and unchanged world hash was then delivered to the same GM session, which acknowledged it with `accept` and requested a fuller bounded projection before any scope is considered. The canonical world remained byte-identical at SHA `2d80c927…56774e`; no candidate, release or resident effect was invented. The GM-06 historical timeout remains explicitly acknowledged with unknown usage, and GM-05's partial usage remains marked unknown. The published GM checkpoint and developer usage snapshot now contain 16 GM attempts and 2,218,787 known tokens; `gm_usage_complete` remains false because those historical unknowns are preserved. [Evidence](worlds/restart-20260918-01/gm/seq000323-gm04-real-observe-feedback-20260923.json) · [GM checkpoint](worlds/restart-20260918-01/gm/observe-feedback-seq323-660f53814f49f545.gm-state.json)

## 2026-09-23 · H142 Seq323 persistence and gameplay surface audit

A read-only audit of the published seq323 checkpoint and a separate cold copy preserved all nested fields byte-for-byte: ten residents, seq323, 323 life events, 10 accounts, 2 contracts, the depleted finite iron source (initial3/recovered3/stock0), 145 trade commands, settled resident controllers, and no pending physical job or provider error. On a separately copied seq323 world, real collision-aware navigation passed 14 checks for market↔field↔trough and an unreachable target, plus 6 stop/restart route checks; the full route graph passed 15,217 checks across 762 routes. The materials, trade, resident-knowledge, controller-replacement and read-only-restore fixtures passed 60, 63, 21, 109 and 11 checks. The repository-owned loopback gateway history harness passed both seed and cold phases, and the 254-check floor-1 geometry/physics, 36-check modular-interior and 21-check starting-quarter fixtures passed with zero model calls. These are strong subsystem and persistence results; the gateway/model-continuity fixtures are explicitly offline, the known four-edge navigation warning remains, and wilderness, combat and multi-floor progression are still unimplemented. [Evidence](worlds/restart-20260918-01/observations/iteration-20260923/seq323-persistence-audit.json)

## 2026-09-23 · H143 Adventure gate is explicitly unimplemented

The surface audit confirms a playable town and floor-1 geometry, but the saved world has no authoritative wilderness, combat, labyrinth, boss or floor-unlock state. Character HP, safe-zone status, weapon skills and floor fields remain explicit null authority slots, and the floor-1 labyrinth is visual-only. The charter requires setting-compatible rules and a reviewed contract before combat; adding guessed damage, death or progression formulas would create a false completion. The next bounded step is to freeze an original `adventure_contract.v1` and its conservation/agency/continuity invariants before implementation. [Gate plan](docs/validation/adventure-gate-2026-09-23.md)

## 2026-09-23 · H144 Adventure contract and isolated reducer fixture

The first adventure scope is now explicit in `game/data/adventure_contract.v1.json`: town safe-zone, wilderness, labyrinth, boss arena, physical entry, attack/guard/flee/recover, finite loot and explicit floor unlock. The contract is an original compatible extension and remains `design_pending_gm_review`; it makes no canon formula, permanent-death or D&D claim. An isolated deterministic reducer and headless acceptance prove 29 checks: town combat refusal, physical zone transitions, idempotent damage, reachable flee, defeat/recovery, explicit boss victory, no implicit floor unlock, finite loot and exact save/load. The reducer is deliberately not wired into seq323 until a real GM proposal/review/effect-feedback cycle accepts the contract. [Contract](game/data/adventure_contract.v1.json) · [Design](docs/design/adventure-contract-v1.md) · [Acceptance](game/tests/adventure_progression_acceptance.gd) · [Evidence](docs/validation/adventure-contract-2026-09-23.json)

## 2026-09-23 · H145 GM accepts the corrected adventure contract conditionally

The first contract review was correctly escalated because the receipt named files without including their content; that measured invalid output is retained. A second review supplied the full contract and finite-loot rules. GM-04 found the setting basis and hard invariants compatible, then requested loot ownership, committed-job behavior, physical entry/retreat, hostile-target scope, capability IDs and primary-source review. After those corrections, the 29-check isolated reducer passed and the same GM acknowledged the revised contract with `accept`. The acknowledgement is conditional: primary-source combat review is still pending, so no reducer wiring, canonical seq323 write or live resident adoption is allowed. The published GM checkpoint records 19 GM attempts and 2,576,259 known tokens; historical partial/unknown usage remains preserved. [Review](worlds/restart-20260918-01/gm/seq000323-gm04-adventure-contract-review-20260923.json)

## 2026-09-23 · H146 Primary-source boundary review for adventure

The official episode references were checked against the contract's setting boundaries. Episode 2 supports first-floor boss progression and coordinated raids; episode 5 supports a monster-excluding Area boundary; episode 7 supports durability, blacksmithing and scarce materials; episode 9 supports withdrawal to a safe area after danger assessment. None establishes the placeholder damage formula, resident damage permission, automatic floor unlock or teleport semantics. The contract is now `design_pending_host_review`; the reducer remains isolated and seq323 is unchanged. [Source review](docs/validation/adventure-primary-source-review-2026-09-23.md) · [Machine evidence](docs/validation/adventure-primary-source-review-2026-09-23.json)

## 2026-09-23 · H147 Host effect decision for adventure

The host reviewed the primary-source boundaries and selected the explicit `max(1, attack_power - defense_power)` damage rule as a project-original extension, not official canon. The contract records the authority boundary: combat values remain undefined until the host supplies authoritative stats, unknown encounter data closes, loot stays world-owned, and no resident-vs-resident damage or automatic floor progression is inferred. GM-04 accepted the bounded effect decision and authorized only a disposable live install with canonical mutation disabled. [Decision](docs/validation/adventure-host-effect-decision-2026-09-23.md) · [Contract](game/data/adventure_contract.v1.json)

## 2026-09-23 · H148 Disposable adventure live install accepted

A separate copy of seq323 loaded TownActions beside the reviewed adventure sidecar and registered 36 host plus 10 adventure capabilities with no collision. Fourteen checks passed: wilderness entry, closed unknown attack, flee to town, exact manifest cold restore and byte-identical source copies. GM-04 accepted the effect receipt with measured usage, while keeping `resident_adoption=false`; the canonical world, checkpoint lineage and ledgers were untouched. This authorizes no canonical integration or resident capability claim. [Evidence](docs/validation/adventure-disposable-live-install-2026-09-23.md) · [GM feedback](private/worlds/restart-20260918-01/gm/receipts/adventure-disposable-live-install-feedback-20260923.json)

## 2026-09-23 · H149 Offline resident action boundary

The disposable resident bridge now exposes `ability:adventure.enter_wilderness` only after a measured collision-aware gate receipt. The fixture controller selected it and passed 15/15 checks: the sidecar entered wilderness, the host life event and command lineage persisted, and both town and sidecar cold restore preserved the result. This is a deterministic action-boundary proof; it makes no claim that a live model selected the action. The canonical seq323 world stayed unchanged. [Evidence](docs/validation/adventure-resident-live-option-2026-09-23.json)

## 2026-09-23 · H150 Scene route integration accepted on a disposable copy

The opt-in scene branch now pauses the normal resident physics loop while it prepares the gate route, preventing the idle loop from clearing the probe's navigation state. A headless real-scene run reached the gate in 1,005 frames over 22.568 m with floor collision observed, saved the disposable manifest and exited without a provider call. The scene evidence records `resident_adoption=false` until an action actually succeeds; the four known navigation edge-merge warnings remain. No canonical save was touched. [Evidence](docs/validation/adventure-resident-live-option-2026-09-23.json)

## 2026-09-23 · H151 Real model sees the adventure choice but keeps agency

One bounded real Kimi request ran against a disposable seq323 copy after the route receipt. Wren (Baker) received the host-gated wilderness option as alias `a31`, chose the valid legacy `life:harvest_ration` action instead, and settled normally. The ledger advanced 376→377 settled at CNY 7.6118814→7.6355809 with no reserved or unknown row; the copy was not promoted and `resident_adoption` remains false. This proves the option reaches a real resident prompt without forcing a new system, while autonomous adventure adoption and canonical integration remain open. [Evidence](docs/validation/adventure-resident-live-option-2026-09-23.md)

## 2026-09-23 · H152 Non-urgent real model sample remains voluntary

A second disposable one-request Kimi run supplied the same host-gated option after restoring Baker's copy to non-urgent food and energy. Wren chose a valid ordinary conversation with the innkeeper rather than wilderness entry; the turn settled and advanced only that disposable copy to seq324. Across H151–H152 the option was visible twice and never forced, while `resident_adoption=false` remained truthful. The external ledger now has 378 settled rows with zero reserved or unknown rows; canonical seq323 was not promoted. [Evidence](docs/validation/adventure-resident-live-option-2026-09-23.md)
...
![真实运行后：种植公共地的三名居民（暂停事后渲染）](docs/validation/town_places_2026-09-13-run/paused-post-run-commons-three-residents.png)
...
![扩建后的城镇全貌](docs/validation/town_expansion_2026-09-12/overview.png)
...
![真实Kimi，GM09修复发布后，10个身份](docs/validation/real_ten_2026-09-12/after-gm09.png)
...
![首次真实十人运行界面](docs/validation/real_ten_2026-09-12/town.png)
...
![十人世界实际领取材料后的画面](docs/validation/gpt6_sprint_2026-09-12/material-work-completed.png)
...
![三人测试世界的实际街道](docs/validation/town_visual_readability_2026-09-12/after_gl_overview.png)

下面是 **9 月 11 日三人生活验证后的冷恢复画面**。铁匠对材料和报酬的顾虑曾推动结算能力改进；详细记录保留了真实 Kimi 调用、玩家澄清与测试档身份的区别。

![生活验证后的同档冷恢复](docs/validation/town_continuous_life_final_2026-09-11.png)
...
![原始模板开启后处理](docs/validation/local_work_2026-09-13/shader-lab/01_baseline_post_on.png)

![修改共享 include 后的验证截图](docs/validation/local_work_2026-09-13/shader-lab/02_live_include_edit.png)
...
![扩建街区总览（暂停的事后渲染）](docs/validation/town_places_2026-09-13-run/paused-post-run-overview.png)

*扩建后的街区与公共设施总览。这是对同世界快照的**暂停事后渲染**，不是新的实时运行。*

![种植公共地的三名居民（暂停的事后渲染）](docs/validation/town_places_2026-09-13-run/paused-post-run-commons-three-residents.png)

*种植公共地：真实运行结束时的三名居民身体（**园丁、守井人、面包师**）就站在公共地里，
名牌由场景自己的居民名牌层随同一台相机绘制；图中名称为该层为这三具身体绘制的本人名牌。*

![西侧前庭的两名居民（暂停的事后渲染）](docs/validation/town_places_2026-09-13-run/paused-post-run-west-forecourt-two-residents.png)

*西侧前庭：**木匠与织工**两名居民身体停在公共前庭（持斧者是木匠，与世界存档一致），
旁边是临街住宅与作坊道具。*

![真实运行结束时的实机画面](docs/validation/town_places_2026-09-13-run/town.png)
...
![店铺外立面](docs/validation/art_parallel_20260912/shopfront/overview.png)

<a id="history-docs-validation-art-parallel-20260912-readme-md--职业工坊设备"></a>
##### 职业工坊设备

![职业工坊设备](docs/validation/art_parallel_20260912/workshops/workshops_overview.png)

<a id="history-docs-validation-art-parallel-20260912-readme-md--旅行与河岸运输"></a>
##### 旅行与河岸运输

![旅行与河岸运输](docs/validation/art_parallel_20260912/travel/travel_contact_sheet.png)

<a id="history-docs-validation-art-parallel-20260912-readme-md--河岸运输补充12件"></a>
##### 河岸运输补充12件

![河岸运输](docs/validation/art_parallel_20260912/travel/river_trade_contact_sheet.png)

<a id="history-docs-validation-art-parallel-20260912-readme-md--旅行营地近景"></a>
##### 旅行营地近景

![营地近景](docs/validation/art_parallel_20260912/travel/caravan_camp_detail.png)

<a id="history-docs-validation-art-parallel-20260912-readme-md--河舟近景"></a>
##### 河舟近景

![河舟近景](docs/validation/art_parallel_20260912/travel/river_trade_detail.png)
...
![修复后的屋面与入口](docs/validation/deepseek_residence_06/repair_2026-09-12/after/porch_structure.png)

| 修复前，同一台 Windows 电脑与视角 | 修复后 |
| --- | --- |
| ![原入口](docs/validation/deepseek_residence_06/repair_2026-09-12/before/near_door.png) | ![新入口](docs/validation/deepseek_residence_06/repair_2026-09-12/after/near_door.png) |
...
![Godot 实际正面视图](docs/validation/deepseek_residence_06/rendered/front_three_quarter.png)

![门口近景：花箱挡门、门廊木梁悬空](docs/validation/deepseek_residence_06/rendered/near_facade_door.png)
...
![普通离线街道的十人冷恢复](docs/validation/gpt6_sprint_2026-09-12/ten-residents-cold.png)

*普通街道冷恢复画面：十个身份，生活事件23，九项采集尚未完成。随后测得的拥堵列为H33；这张图不表示十人供给已持续畅通。*

![实际物理取材在暂停时仍有未完劳动](docs/validation/gpt6_sprint_2026-09-12/material-work-paused.png)

*同一集成世界：脚本选择，实际街道物理；取料劳动已进行约5.17秒，尚未获得第二份铁。画面HUD为验收说明。*

![同一世界恢复后完成有限铁料整理](docs/validation/gpt6_sprint_2026-09-12/material-work-completed.png)
...
![ten residents, real Kimi run](docs/validation/real_ten_2026-09-12/town.png)
...
![neighbourhood overview](docs/validation/town_expansion_2026-09-12/overview.png)

*Overview of the expanded town in the actual scene (offline preview capture).*

![residential street](docs/validation/town_expansion_2026-09-12/south-street.png)

*Ground level: the main street from the plaza gate looking into the new neighbourhood.*

![commons junction](docs/validation/town_expansion_2026-09-12/commons.png)

*Ground level: the planted commons crossing, houses fronting both streets.*

![caravan yard](docs/validation/town_expansion_2026-09-12/caravan-yard.png)
...
- 前：![before_gl_overview](docs/validation/town_visual_readability_2026-09-12/before_gl_overview.png)
- 后（GL）：![after_gl_overview](docs/validation/town_visual_readability_2026-09-12/after_gl_overview.png) ![after_gl_residents](docs/validation/town_visual_readability_2026-09-12/after_gl_residents.png) ![after_gl_logical](docs/validation/town_visual_readability_2026-09-12/after_gl_logical.png)
- 后（Forward+）：![after_forward_overview](docs/validation/town_visual_readability_2026-09-12/after_forward_overview.png) ![after_forward_residents](docs/validation/town_visual_readability_2026-09-12/after_forward_residents.png)
...
![Godot-imported first-floor street](docs/validation/floor1_art_2026-09-11/floor1_godot.png)

![Blender hero render](docs/validation/floor1_art_2026-09-11/floor1_hero.png)
...
![Vegetation catalogue](docs/validation/floor1_environment_kit_20_2026-09-11/environment_kit_20_vegetation.png)

![Hard-component catalogue](docs/validation/floor1_environment_kit_20_2026-09-11/environment_kit_20_components.png)
...
![新版植物近景](docs/validation/floor1_environment_v2_2026-09-11/final/botanical_close.png)

![新版香草箱近景](docs/validation/floor1_environment_v2_2026-09-11/final/planter_close.png)
...
![五种住宅 · Godot 实时渲染](docs/validation/floor1_residences_2026-09-11/final/catalogue.png)
...
![Completed fixture repair and settlement](docs/validation/repair_work_2026-09-11/repair.png)
...
![Godot 实际续接画面，失败状态保留](docs/validation/town_continuation_2026-09-11/town.png)
...
![同一场景冷启动，显示铁匠真实公开顾虑](docs/validation/town_continuous_life_2026-09-11.png)
...
![真实履约使用后的冷启动：工具已修好并取回，旧发言明确标为历史对话](docs/validation/town_continuous_life_final_2026-09-11.png)
...
![实际 Godot 画面](docs/validation/town_feedback_2026-09-11.png)
...
![Town after cold restore](docs/validation/town_life_2026-09-10/town.png)
...
![同档冷恢复后的铁匠与剩余2份余料](docs/validation/town_materials_2026-09-11.png)
...
![Actual Godot scene while the third controller waits](docs/validation/town_online_2026-09-11/waiting.png)
...
![真实 Kimi 交易结果冷启动；测试世界、当前暂停](docs/validation/town_trade_2026-09-11/live-cold.png)
...
![真实模型选择进入Godot](docs/validation/real_kimi_choice_2026-09-10/model-choice.png)
...
![实际Godot完成画面](docs/validation/real_kimi_use_2026-09-10/complete.png)
...
![Godot实际结果](docs/validation/resident_knowledge_2026-09-10/visitor.png)
...
![同一事件恢复后的街道](docs/validation/windows_preview_2026-09-10/restored.png)
...
![Market and household contact sheet](deliveries/20260912-art/docs/validation/art_batch_20260912/market/market_contact_sheet_preview.png)
...
![Market stalls and handcart](deliveries/20260912-art/docs/validation/art_batch_20260912/market/market_stalls_detail.png)

![Carpentry and spinning craft](deliveries/20260912-art/docs/validation/art_batch_20260912/market/craft_detail.png)

![Provisions, pottery and merchant balance](deliveries/20260912-art/docs/validation/art_batch_20260912/market/provisions_detail.png)

![Furniture and loom](deliveries/20260912-art/docs/validation/art_batch_20260912/market/interior_furniture_detail.png)

![Household cooking and travel props](deliveries/20260912-art/docs/validation/art_batch_20260912/market/household_craft_detail.png)
...
![店铺外立面](deliveries/20260912-art/docs/validation/art_parallel_20260912/shopfront/overview.png)

<a id="history-deliveries-20260912-art-docs-validation-art-parallel-20260912-readme-md--职业工坊设备"></a>
##### 职业工坊设备

![职业工坊设备](deliveries/20260912-art/docs/validation/art_parallel_20260912/workshops/workshops_overview.png)

<a id="history-deliveries-20260912-art-docs-validation-art-parallel-20260912-readme-md--旅行与河岸运输"></a>
##### 旅行与河岸运输

![旅行与河岸运输](deliveries/20260912-art/docs/validation/art_parallel_20260912/travel/travel_contact_sheet.png)

<a id="history-deliveries-20260912-art-docs-validation-art-parallel-20260912-readme-md--河岸运输补充12件"></a>
##### 河岸运输补充12件

![河岸运输](deliveries/20260912-art/docs/validation/art_parallel_20260912/travel/river_trade_contact_sheet.png)

<a id="history-deliveries-20260912-art-docs-validation-art-parallel-20260912-readme-md--旅行营地近景"></a>
##### 旅行营地近景

![营地近景](deliveries/20260912-art/docs/validation/art_parallel_20260912/travel/caravan_camp_detail.png)

<a id="history-deliveries-20260912-art-docs-validation-art-parallel-20260912-readme-md--河舟近景"></a>
##### 河舟近景

![河舟近景](deliveries/20260912-art/docs/validation/art_parallel_20260912/travel/river_trade_detail.png)
